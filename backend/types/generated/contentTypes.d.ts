...
export interface ApiMoreLodgingInfoMoreLodgingInfo
  extends Schema.CollectionType {
  collectionName: 'more_lodging_infos';
  info: {
    singularName: 'more-lodging-info';
    pluralName: 'more-lodging-infos';
    displayName: 'More_lodging_info';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::more-lodging-info.more-lodging-info',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
  ...
  attributes: {
    ...
    contentSections: Attribute.DynamicZone<
      [
        ...
        'sections.gatherings',
        'elements.details',
        'elements.things-needed',
        'elements.things-needed-header',
        'elements.lodging',
        'sections.registration',
        'elements.registration',
        'elements.register-button',
        'elements.lodging-continued',
        'sections.thanks'
      ]
    > &
      Attribute.SetPluginOptions<{
    ...
    more_lodging_infos: Attribute.Relation<
      'api::page.page',
      'oneToMany',
      'api::more-lodging-info.more-lodging-info'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::more-lodging-info.more-lodging-info': ApiMoreLodgingInfoMoreLodgingInfo;
